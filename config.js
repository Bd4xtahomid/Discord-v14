module.exports = {
  ...
  DASHBOARD: {
    ...
    baseURL: "http://in5.phenoixhost.link:25002", // base url
    failureURL: "http://in5.phenoixhost.link:25002", // failure redirect url
    port: "25002", // port to run the bot on
  },
  ...
  MUSIC: {
    ...
    LAVALINK_NODES: [
    ...
    
      {
        ...
        port: 7774,
        password: "http://discord.gg/toz",
        id: "Music-2",
        secure: false,
      },
      {
        host: "fn2.solarnode.xyz",
  ...
  PRESENCE: {
    ...
    MESSAGE: " over {members} Users", // Your bot status message
  },
